...
"TeamLogo": '/static/images/team-logo.png',
#右侧栏团队LOGO URL

"TeamName": 'SaintIC',
#右侧栏团队名称

"TeamURL": 'http://www.saintic.com',
#右侧栏团队URL

"TeamMotto": u"""原谅我这一生不羁放纵爱自由,也会怕有一天会跌倒,被弃了理想谁人都可以,那会怕有一天只你共我!""",
#右侧栏格言部分

"AboutContent": u"""我对茶情有独钟，买什么都喜欢带有淡淡的茶香味，在袅袅的茶气中，泡着茶，提壶、注水、出汤、品尝，自然平静，俨然与茶浑然一体。泡茶和喝茶重要的是用心，只要用心，不一定是昂贵的>茶叶，不一定要精雕细刻的茶具，也不需要复杂多变的手法，一样能够泡出清香四溢、韵味十足的好茶。若是感到心烦意乱、孤独寂寞、茫然无助，就为自己泡茶。淡而入心，唯有茶也。""",
#关于我内容配置
}
