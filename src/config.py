...
"AboutContent": """<p>我对茶情有独钟，买什么都喜欢带有淡淡的茶香味，在袅袅的茶气中，泡着茶，提壶、注水、出汤、品尝，自然平静，俨然与茶浑然一体。泡茶和喝茶重要的是用心，只要用心，不一定是昂贵的茶叶，不一定要精雕细刻的茶具，也不需要>复杂多变的手法，一样能够泡出清香四溢、韵味十足的好茶。若是感到心烦意乱、孤独寂寞、茫然无助，就为自己泡茶。淡>而入心，唯有茶也</p>"""
#关于我内容配置
}
